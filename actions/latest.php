...
class Latest_Action extends Red_Action {
	...
	function process_before( $code, $target ) {
		...
		global $wpdb;
		$id = $wpdb->get_var( "SELECT ID FROM {$wpdb->prefix}posts WHERE post_status='publish' AND post_password='' AND post_type='post' ORDER BY ID DESC LIMIT 0,1" );
