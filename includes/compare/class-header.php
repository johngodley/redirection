 ...
 *
 * @phpstan-extends Compare<HeaderMap, HeaderResult>
 */
class Header extends Compare {
	use FromNotFrom;
	 ...
	 * @phpstan-param HeaderMap $details
	 * @return HeaderResult
	 */
	...
	public function is_match( $url ) {
		if ( $this->regex ) {
			...
			$header = Request::get_header( $this->name );
		...
		return Request::get_header( $this->name ) === $this->value;
	}
