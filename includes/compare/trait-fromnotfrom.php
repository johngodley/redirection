...
trait FromNotFrom {
	 ...
	 * @phpstan-param FromNotFromMap $details New match data.
	 * @param array<string, mixed> $details New match data.
	 ...
	 * @param \Redirection\Url\SourceFlags $flags Redirect flags.
	 * @param boolean          $matched Has the source been matched.
	 * @return string|false
	 */
	public function get_target_url( $requested_url, $source_url, \Redirection\Url\SourceFlags $flags, $matched ) {
