 ...
 *
 * @phpstan-extends Compare<PageMap, PageResult>
 */
class Page extends Compare {
	use FromUrl;
	 ...
	 * @phpstan-param PageMap $details
	 * @return PageResult
	 */
	public function save( array $details, $no_target_url = false ) {
		$data = [ 'page' => isset( $details['page'] ) ? $this->sanitize_page( $details['page'] ) : '404' ];
	...
	public function load( $values ) {
		...
		$this->page = $data['page'] ?? '404'; // @phpstan-ignore-line
	}
}
