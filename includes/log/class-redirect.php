...
/**
 * @phpstan-import-type LogJson from Log
 * @phpstan-import-type LogFilterParams from Log
 * @phpstan-import-type LogGetParams from Log
...
class Redirect extends Log {
	...
	public function __construct( $values ) {
		...
		if ( isset( $values['sent_to'] ) ) {
			$this->sent_to = (string) $values['sent_to'];
		}

		if ( isset( $values['redirect_by'] ) ) {
			$this->redirect_by = (string) $values['redirect_by'];
		}
	}
