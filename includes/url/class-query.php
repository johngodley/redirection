...
class Query {
	 ...
	 * @param SourceFlags $flags URL flags.
	 */
	 ...
	 * @param SourceFlags $flags Source flags.
	 * @return boolean
	 */
	public function is_match( $url, SourceFlags $flags ) {
		if ( $flags->is_ignore_case() ) {
	 ...
	 * @param SourceFlags $flags Any URL flags.
	 * @return string URL, modified or not.
	 */
	public static function add_to_target( $target_url, $requested_url, SourceFlags $flags ) {
	 ...
	 * @phpstan-param QueryParams $query_array
	 * @return string
	 */
	 ...
	 * @phpstan-param QueryParams $query
	 ...
	 * @phpstan-param QueryParams $source_query
	 * @phpstan-param QueryParams $target_query
	 * @return QueryParams
	 */
