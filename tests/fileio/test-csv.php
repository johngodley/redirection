...
require_once dirname( __FILE__ ) . '/../../includes/file-io/fileio-csv.php';
...
class ExportCsvTest extends WP_UnitTestCase {
	...
	public function testMultipleLines() {
		$exporter = new FileIO\Csv();
		$item1 = new Redirect\Redirect( (object) array( 'match_type' => 'url', 'id' => 1, 'regex' => false, 'action_type' => 'url', 'url' => '/source1', 'action_data' => '/target', 'action_code' => 301 ) );
		$item2 = new Redirect\Redirect( (object) array( 'match_type' => 'url', 'id' => 1, 'regex' => false, 'action_type' => 'url', 'url' => '/source2', 'action_data' => '/target', 'action_code' => 301 ) );
	...
	public function testExportReferrer() {
		...
		$item = new Redirect\Redirect( (object) array( 'match_type' => 'referrer', 'id' => 1, 'regex' => false, 'action_type' => 'url', 'url' => '/source1', 'action_data' => $target, 'action_code' => 301 ) );
		$csv = $exporter->item_as_csv( $item );
