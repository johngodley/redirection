...
class ReferrerMatchTest extends WP_UnitTestCase {
	...
	public function testNotMatch() {
		...
		$match = new Match\Referrer( serialize( array( 'referrer' => 'other', 'regex' => false, 'url_from' => '', 'url_notfrom' => '' ) ) );
	...
	public function testNotMatchNotExists() {
		...
		$match = new Match\Referrer( serialize( array( 'referrer' => 'other', 'regex' => true, 'url_from' => '', 'url_notfrom' => '' ) ) );
		$this->assertFalse( $match->is_match( '' ) );
	}
	...
	public function testMatch() {
		...
		$match = new Match\Referrer( serialize( array( 'referrer' => 'nothing', 'regex' => false, 'url_from' => '', 'url_notfrom' => '' ) ) );
	...
	public function testMatchRegex() {
		...
		$match = new Match\Referrer( serialize( array( 'referrer' => 'agent.*', 'regex' => true, 'url_from' => '/other/$1', 'url_notfrom' => '/notfrom' ) ) );
		$this->assertTrue( $match->is_match( '' ) );
	}
}
