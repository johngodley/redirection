		...
		return (
			<React.Fragment>
				<tr>
					...
					<td>
						<input type="text" name="url_from" value={ this.props.url_from } onChange={ this.onChange } placeholder={ __( 'Target URL when matched' ) } />
					</td>
				</tr>
				<tr>
					<th>{ __( 'Unmatched Target' ) }</th>
					<td>
						<input type="text" name="url_notfrom" value={ this.props.url_notfrom } onChange={ this.onChange } placeholder={ __( 'Target URL when not matched' ) } />
					</td>
				</tr>
			</React.Fragment>
		);
