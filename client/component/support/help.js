		...
		<div>
			...
			<p>
				{ __( 'Full documentation for Redirection can be found at {{site}}https://redirection.me{{/site}}. If you have a problem please check the {{faq}}FAQ{{/faq}} first.', {
					components: {
						site: <a href="https://redirection.me" target="_blank" rel="noopener noreferrer" />,
						faq: <a href="https://redirection.me/support/faq/" target="_blank" rel="noopener noreferrer" />,
					},
				} ) }
			</p>
			<p><strong>{ __( 'If you want to report a bug please read the {{report}}Reporting Bugs{{/report}} guide.', {
				components: {
					report: <a href="https://redirection.me/support/reporting-bugs/" target="_blank" rel="noopener noreferrer" />,
				},
			} ) }</strong></p>
