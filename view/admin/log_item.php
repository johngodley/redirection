<td><a href="#" onclick="show_log(<?php echo $log->id ?>);return false"><?php echo date (get_option ('date_format'), $log->created) ?></a></td>
<td><a href="<?php echo $this->url ($log->url) ?>"><?php echo $log->show_url ($log->url) ?></a></td>
<td>
